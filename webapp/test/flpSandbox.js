		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Picklist ",
									"targetURL": "#picklistmanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"picklistmanagement-display": {
								"semanticObject": "picklistmanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=picklistmanagement",
									"url": sap.ui.require.toUrl("picklistmanagement")
								}
							}
						}
					}
